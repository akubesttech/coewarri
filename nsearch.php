...
<div class="container">
                    ...
                    <div id="searchResults">
                        <div class="margin-md-bottom">
							...
							<form method="get" action="post.php?view=nMore" id="top_search">
								...
								<input class="search-page-control form-control" id="q2" name="search" autocomplete="on" placeholder="Enter search terms" type="text">
							</form>
						</div>
                    </div>
                </div>
    ...
    $pagination =  new Pagination($pagConfig);
		...
		$sql = $sql . " where  status ='TRUE'";
			...
			$sql = $sql . " GROUP BY news_type,news_id ORDER BY news_id desc LIMIT $limit";
