...
$result2 = mysqli_query($condb,"DELETE FROM results where dept = '".$dept."' and course_code ='".$course."' and session ='".$session."' and semester ='".$semester."' and level ='".$level."'");
}
//header("location:Result_am.php?view=v_upa");
redirect("Result_am.php?view=v_upa");
}
?>